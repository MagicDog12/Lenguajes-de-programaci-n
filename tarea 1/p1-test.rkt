...
(test/exn (run '{{|| 3 1}}) "Runtime type error: expected Bool found Number")
;; caso: if
(test/exn (run '{{if 1 1 2}}) "Runtime type error: expected Bool found Number")
...
;; caso 2: ||
(test/exn (run '{{|| #f {cons 0 4}}}) "Runtime type error: expected Bool found Pair")
;; caso 3: ||
...
;; caso: snd
(test/exn (run '{{snd 2}}) "Runtime type error: expected Pair found Number")

;; Casos en que esperabamos un par y le damos un booleano:
;; caso: fst
(test/exn (run '{{fst #t}}) "Runtime type error: expected Pair found Bool")
;; caso: snd
(test/exn (run '{{snd #t}}) "Runtime type error: expected Pair found Bool")
